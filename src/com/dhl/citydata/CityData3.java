...
public class CityData3 {
	public static void main(String[] args) throws Exception {
		...
		String sql = "SELECT u.inv_id,u.user_name,u.user_dept,u.user_phone,u.user_email,u.mail_address,u.user_province,u.user_city,u.user_position,u.user_ask FROM inv_question_userinfo1 u  WHERE  u.inv_allow='cd'";
		...
		Writer writer = new FileWriter("F:\\var\\cd.txt");
		for(int i=0;i<userList.size();i++) {
			Map<String,Object> uMap = userList.get(i);
			...
			sb.append("\t");
			sb.append(uMap.get("mail_address"));
			sb.append("\t");
