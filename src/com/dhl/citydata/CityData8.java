...
public class CityData8 {
	public static void main(String[] args) throws Exception {
		...
		String sql = "SELECT u.inv_id,u.user_name,u.user_dept,u.user_phone,u.user_email,u.user_province,u.user_city,u.user_position,u.user_ask FROM inv_question_userinfo1 u  WHERE  u.inv_allow='nj'";
		...
		Writer writer = new FileWriter("F:\\var\\nj.txt");
		for(int i=0;i<userList.size();i++) {
			Map<String,Object> uMap = userList.get(i);
